...
}), _defineProperty(_DEFAULT_PLACEHOLDERS, "digits", {
  digits: function digits(_ref9) {
    var params = _ref9.params;
    return params[0];
  }
}), _defineProperty(_DEFAULT_PLACEHOLDERS, "digits_between", {
  min: function min(_ref10) {
    var params = _ref10.params;
    return params[0];
  },
  max: function max(_ref11) {
...
function generateMessage(rule, ruleParams, fieldData) {
